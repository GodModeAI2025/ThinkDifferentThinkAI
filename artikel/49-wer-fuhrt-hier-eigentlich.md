---
folge: 49
titel: "Intent, Agent Performance, Human Check: Führen, wenn jeder 109 Agenten hat"
bildtitel: "Wer führt hier eigentlich?"
kicker: "Im Gespräch mit Dr. René Deist"
podigee: "https://think-ai.podigee.io/49-wer-fuhrt-hier-eigentlich"
---
...
> **kurz & knapp**
>
> - Aus dem Modell „Intent, Operate, Check“ ist „Intent, Agent Performance, Human Check“ geworden
> - KI hat keinen eigenen Intent und kann kein Risiko bewerten, weil sie es nicht fühlt
> - Berufsbilder verschieben sich zum Master im Intent oder zum Master in Check und Control
> - Es braucht mehr Führungskräfte, nicht weniger: Zwei kooperierende Abteilungen bringen 218 Agenten mit
> - Prompt Thinking wirkt nur dort, wo das Handwerk ohnehin sitzt
...
> ### Warum „Operate“ zu „Agent Performance“ wurde
>
> In der ursprünglichen Fassung hieß das Modell „Intent, Operate, Check“. Die Umbenennung des Mittelteils ist keine Kosmetik, sondern beschreibt eine veränderte Realität.
>
> „Operate“ legt nahe, dass jemand einen Ablauf ausführt, der vorher festgelegt wurde. Genau das trifft auf agentische Systeme nicht mehr zu: Sie entscheiden zur Laufzeit, welchen Schritt sie als Nächstes gehen, und der Weg zum Ergebnis steht vorher nicht fest. „Agent Performance“ macht sichtbar, dass hier eine Leistung erbracht wird, deren Verlauf variabel ist.
>
> Die praktische Folge betrifft die Prüfung. Ein festgelegter Ablauf lässt sich stichprobenartig kontrollieren, weil Abweichungen selten sind. Bei variablem Verlauf muss die Prüfung am Ergebnis ansetzen, und sie muss jedes Mal stattfinden. Deist verweist dafür auf Scoring-Modelle und auf LLM as a Judge, also auf ein zweites Modell, das die Arbeit des ersten bewertet.
...
> **The story continues …**
>
> Der eindringlichste Teil der Folge betrifft Kinder. Deist rät, den Dialogmodus aktueller Modelle einmal auszuprobieren, weil er kaum noch von einem Gespräch zu unterscheiden ist. Daraus entsteht gerade ein Markt für verkaufte Beziehungen, samt Apps für Kinder mit frei gestaltbarem Companion. Seine Position dazu ist eindeutig: Heranwachsende brauchen Reibung, und ein Companion streitet nie, weil er gefallen will. Sein praktischer Rat aus dem eigenen Haushalt: jede App, die die Kinder installieren, selbst installieren und selbst spielen.

---

Die ganze Folge: [Wer führt hier eigentlich?](https://think-ai.podigee.io/49-wer-fuhrt-hier-eigentlich)
