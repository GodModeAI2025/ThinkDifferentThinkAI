---
folge: 19
titel: "Prompt-Drift und der verschwundene Klick: KI-Bilanz eines Jahres"
bildtitel: "Der Klick bleibt aus"
kicker: "Fachartikel zur Folge"
podigee: "https://think-ai.podigee.io/19-2025-wrapped"
---
...
> **kurz & knapp**
>
> - Prompt-Drift: Etablierte Prompts liefern nach einem Versionssprung plötzlich andere Ergebnisse
> - Seit Gemini im Suchfeld sitzt, bleibt der Klick auf die Quelle aus
> - 2026 soll Werbung in die KI-Suchergebnisse einziehen
> - Siri und Alexa hängen zurück, könnten über MCP und A2A aber eine Renaissance erleben
> - Wer 2025 das meiste herausholen wollte, brauchte weiterhin Herrschaftswissen
...
> ### Warum Prompt-Drift unvermeidlich ist
>
> Ein Prompt ist keine Anweisung an eine Maschine, sondern eine Eingabe in ein statistisches System. Er funktioniert, weil er in diesem konkreten Modell zuverlässig eine bestimmte Reaktion auslöst.
>
> Ein neues Modell ist ein anderes System. Es wurde auf anderen Daten trainiert, anders nachjustiert und hat einen anderen System-Prompt darüber. Dass ein Prompt weiterhin gleich wirkt, ist der Zufall, nicht die Regel.
>
> Daraus folgen drei praktische Konsequenzen. **Erstens:** Prompts, auf denen etwas Wichtiges beruht, brauchen Testfälle mit erwarteten Ergebnissen, die man nach jedem Modellwechsel durchlaufen lässt. **Zweitens:** Pinnen Sie die Modellversion in produktiven Abläufen, statt automatisch auf die neueste zu wechseln. **Drittens:** Formulieren Sie so, dass das Format erzwungen wird, etwa durch ein vorgegebenes Ausgabeschema. Ein erzwungenes Format übersteht einen Versionssprung besser als eine ausgefeilte Formulierung.
>
> Genau hier liegt der Vorteil von Skills gegenüber Prompts: Sie beschreiben die Aufgabe samt Format und lassen sich prüfen.
...
> **The story continues …**
>
> Werbung in KI-Suchergebnissen ist für 2026 angekündigt. Wie sie sich von der Antwort unterscheiden lässt, ist ungeklärt. Bei der klassischen Suche gibt es dafür eine Kennzeichnung neben dem Ergebnis. In einem Fließtext, der eine Frage beantwortet, gibt es dieses Danebenstehen nicht.

---

Die ganze Folge: [2025 Wrapped](https://think-ai.podigee.io/19-2025-wrapped)
