---
folge: 2
titel: "Bot, Tool, Agent, Agentic: Vier Begriffe, die ständig verwechselt werden"
bildtitel: "Vier Begriffe, klar getrennt"
kicker: "Fachartikel zur Folge"
podigee: "https://think-ai.podigee.io/2-zwischen-bots-agenten-und-20-kilo-fleisch"
---
...
> **kurz & knapp**
>
> - Ein Bot antwortet auf Prompts, ohne eigenen Plan
> - Ein Tool erweitert diesen Bot um konkrete Fähigkeiten, angebunden etwa über MCP
> - MCP ist die USB-Schnittstelle für Software
> - Ein Agent bekommt ein Ziel statt eines Prompts und behält Kontext über längere Zeit
> - Agentic heißt: mehrere Agenten arbeiten an ähnlichen oder verschiedenen Zielen

## Die vier Ebenen

> ### Wo genau die Grenzen verlaufen
>
> **Bot.** Ein System im Stil von Eliza antwortet auf eine Eingabe und vergisst danach. Es hat keinen Plan und kein Ziel, nur eine Reaktion. Das gilt für die meisten Chatfenster, sobald man ihnen keine Werkzeuge gibt.
>
> **Tool.** Eine konkrete Fähigkeit, die dem Bot zur Verfügung steht, etwa ein per MCP angebundenes 3D-Programm. Das Bild von MCP als USB-Schnittstelle für Software trifft: eine einheitliche Steckverbindung, hinter der Verschiedenes hängen kann.
>
> **Agent.** Der Bruch. Ein Agent bekommt ein Ziel statt eines Prompts und verfolgt es eigenständig über mehrere Schritte hinweg, mit Kontext über eine längere Zeitspanne. Der Unterschied ist keine Fähigkeitsfrage, sondern eine Auftragsfrage.
>
> **Agentic.** Mehrere Agenten arbeiten koordiniert oder unkoordiniert an ähnlichen oder verschiedenen Zielen. Hier entstehen die Probleme, die es auf den unteren Ebenen nicht gibt: Wer koordiniert, wer entscheidet bei Widerspruch, wer haftet.
>
> Die praktische Prüffrage lautet deshalb nicht „hat es KI“, sondern: Bekommt das System einen Auftrag oder ein Ziel. Bei einem Auftrag kennen Sie den Weg. Bei einem Ziel kennen Sie ihn nicht.
...
> **The story continues …**
>
> Die Frage nach Quellenangaben ist praktisch noch offen. Solange ein Mensch das Ergebnis prüft, braucht er sie. Sobald ein Agent das Ergebnis eines anderen Agenten übernimmt, prüft niemand mehr die Quelle, und die Kette wird nur so verlässlich wie ihr schwächstes Glied.

---

Die ganze Folge: [Zwischen Bots, Agenten und 20 Kilo Fleisch](https://think-ai.podigee.io/2-zwischen-bots-agenten-und-20-kilo-fleisch)
